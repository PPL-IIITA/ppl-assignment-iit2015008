 ...
 */
public class couple {
    public String boyName , girlName ;
    public int happinessLevel , compatability , attractivenessDifference , intelligentDifference , budgetDifference ;
    public int bIndex , gIndex ;
    public couple(String bName , String gName , int boyAttractiveness , int girlAttractiveness , int boyIntelligence , int girlIntelligence , int boyBudget , int girlBudget , int boyHappiness , int girlHappiness , int bIndex , int gIndex){
        this.boyName = bName ;
        this.girlName = gName ;
